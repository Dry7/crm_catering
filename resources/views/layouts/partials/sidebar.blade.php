...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li{!! (is_object(\Request::route()) and (\Request::route()->getName() == 'log.index')) ? ' class="active"' : '' !!}><a href="{{ route('log.index') }}"><i class='fa fa-user'></i> <span>Действия менеджеров</span></a></li>
            @endif
