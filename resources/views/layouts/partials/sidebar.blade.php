...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li{!! (is_object(\Request::route()) and (\Request::route()->getName() == 'calendar.index')) ? ' class="active"' : '' !!} style="display: none"><a href="{{ route('calendar.index') }}"><i class='fa fa-user'></i> <span>Календарь проектов</span></a></li>
        </ul>
    </section>
</aside>
